...
namespace MonadParser
{
    public class Calculator
    {
        ...
        private static Parser<A> DefObject<A>(string name, A value) => Parser<string>.Name(name).Skip(() => Parser<A>.Pure(value));
        ...
        private static readonly Parser<char> br_open = Parser<char>.Symbol('(');
        private static readonly Parser<char> br_close = Parser<char>.Symbol(')');
